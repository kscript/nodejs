(function(window,document){
		...
		jQuery.fn=jQuery.prototype={
			...
			init:function(selector,context){
				...
				if(!conf.isRefresh&&cache[selector]){
					...
					return  jQuery._self.call(cache[selector]);
				}else{
				...
				res.$parent=context;
				//设置缓存
				return jQuery.setCache.call(this,selector,res);
			}
		};
		...
		jQuery.fn.extend({
			...
			siblings:function(sel){
				...
				this.siblings=$(res);
				this.selector=this.selector+" :siblings("+sel+")";
				return jQuery.setCache.call(this.siblings,this.selector,this.siblings);
			},
			child:function(sel,cxt){
				...
				res.$parent=this;
				res.selector=this.selector+" :child("+sel+")"
				return jQuery.setCache.call(res,res.selector,res);
			},
			index:function(){
				return 1;
			}
